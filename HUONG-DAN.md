...
| **Mã giảm giá** | Không bắt buộc. Nút Đặt hàng vẫn hiện giá đầy đủ; đặt xong, màn "Đã đặt hàng" hiện tổng đã giảm và dòng "Coupon applied", bảng/trang thanh toán thu đúng số đã giảm |
...
cho tài khoản của bạn, bảng nhập thẻ của Stripe **tự mở ngay sau khi bấm Đặt hàng** (có ô lưu thẻ cho lần
sau); đóng bảng thì bấm **"Thanh toán ngay"** để mở lại. Chưa bật — hoặc một đơn cụ thể app không mở được
bảng — thì **"Thanh toán ngay"** mở **trang thanh toán trên trình duyệt** (trang này có thể có thêm cách trả
khác tuỳ Cedar247 bật). Nút **"Thanh toán ngay"** nằm ở màn hình ngay sau khi đặt và ở tab **Đơn hàng**.
