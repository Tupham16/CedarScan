...
enum LegalDoc: String, CaseIterable, Identifiable {
    ...
    /// address, so the property address keeps App Functionality only, and the hand-made copies no longer
    /// read as all holding the password hash.)
