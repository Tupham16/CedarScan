...
enum LegalDoc: String, CaseIterable, Identifiable {
    ...
    /// order of each paid order, tour room names); "Why we use your data" names testing + reports.)
...
extension LegalDoc {
    static let privacySectionsFR: [(String, String)] = [
        ...
        ("Pourquoi nous utilisons vos renseignements",
         "Pour exécuter notre contrat avec vous : produire et livrer les plans que vous commandez, encaisser le paiement et vous assister ensuite. Pour nos intérêts légitimes : maintenir la sécurité et le fonctionnement du service, tester ses modifications, établir des rapports internes, prévenir les abus des promotions et améliorer la précision des consignes de capture. Pour respecter nos obligations légales : fiscalité, comptabilité et tenue de registres. Lorsque la loi exige un consentement — par exemple pour la localisation de l'appareil — nous le demandons, et vous pouvez le refuser ou le retirer dans les réglages de votre appareil."),
