...
enum Fog6 {
    ...
    static func seed() {
        ...
        let now = Date()
        let projects = [
            ScanProject(id: maple, name: "63 Saint James Road, Cowbridge, CF71 7QW, GB", createdAt: now),
            ScanProject(id: oak, name: "27 Llanmaes Road Business Park Unit 4, Llantwit Major, CF61 2XD, GB", createdAt: now.addingTimeInterval(-86400)),
        ]
...
struct Fog6ShotRoot: View {
    ...
    var body: some View {
        ...
        case "addon", "addon-coupon", "addon-done", "addon-blocked", "addon-notdelivered", "addon-done-notdelivered", "addon-lost":
            Color.gray.opacity(0.35).ignoresSafeArea()
